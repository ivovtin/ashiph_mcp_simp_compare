void npe_momentum_draw()
{
   ...
   nphe11->SetParameter(1,2.40);  // for n=1.05 6cm Integral SiPM OverVoltage=2V -> PDE(500)=25%
   nphe11->SetParName(2,"Const.lev from SiPM noises");
   //nphe11->SetParameter(2,0.351); // for 4.5MHz and window 78ns
   nphe11->SetParameter(2,0.05); // for 4.5MHz and window 78ns
   //nphe11->SetParameter(3,0.14);
   nphe11->SetParameter(3,0.05);
   ...
   TProfile* npemu=new TProfile("npemu","",1000,-0.5,990.5);  
   TH2F* null2=new TH2F("null2","",200,0,1000,55,-0.05,5.505); // for n=1.05 and t=6cm
   ...
   TLegend* leg1=new TLegend(100,2.3,200,3.,"","");
   TLegendEntry *le1=leg1->AddEntry(npemu,"#mu","elp");
